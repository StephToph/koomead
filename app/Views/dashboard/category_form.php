<?php
    ...
    $this->Crud = new Crud();
?>
<?php echo form_open_multipart($form_link, array('id'=>'bb_ajax_form', 'class'=>'text-start customform')); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mb-3">
                <div class="form-group">
                    ...
                    <select id="category_id" name="category_id" class="form-select selects2" required>
                        <option value="0">None</option>
                        <?php 
                            $category = $this->Crud->read_single_order('category_id', 0, 'category', 'name', 'asc');
                            if(!empty($category)) {
                                foreach($category as $c) {
                                    $c_sel = '';
                                    if(!empty($e_category_id)) {
                                        if($e_category_id == $c->id) { $c_sel = 'selected'; }
                                    }
            ...
            <div class="col-sm-6 mb-3">
                <div class="form-group">
                    ...
                    <select id="status" name="status" class="form-select selects2">
                        
                        <option value="0" <?php if(!empty($e_status)){if($e_status == 0){echo 'selected';}} ?>>Active</option>';
                        <option value="1" <?php if(!empty($e_status)){if($e_status == 1){echo 'selected';}} ?>>Disabled</option>';
            ...
            <div class="col-sm-12 text-center mb-5">
                <div style="background-color:#f6f6f6; margin:2px; padding: 15px;">
                    <div class="text-muted text-center"><b>CATEGORY IMAGE</b></div>
                    <label for="img-upload" class="pointer text-center" style="cursor:pointer;">
