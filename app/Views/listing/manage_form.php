        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="listsearch-input-item mb-2">
                        <select data-placeholder="Select" id="promotion_id" name="promotion_id" onchange="promote();" required class="mb-2 select22 form-select">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="markerter_id"> <span class="dec-icon"><i class="far fa-clock"></i> </span> Duration</label>
...
<script>
    ...
    function promote(){
        ...
        if(promotion_id !== ''){
            $.ajax({
                url: site_url + 'listing/promote/' + promotion_id,
                type: 'post',
                success: function (data) {
                    var dt = JSON.parse(data);
                    $('#amount').html(dt.item);
                    $('#duration').append(dt.item);
