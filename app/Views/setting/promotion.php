...
<div class="dashboard-content">
        ...
        <div class="dasboard-wrapper fl-wrap">
            <div class="dasboard-listing-box fl-wrap">
                ...
                <div class="dasboard-opt sl-opt fl-wrap float-end">
                    ...
                    <a href="javascript:;" pageName="<?=site_url('settings/promotion/manage');?>" pageTitle="Add" class="btn btn-primary pop float-end">Add New <i class="fal fa-plus"></i></a>	
                </div>
    ...
    <script>
        ...
        function load(x, y) {
            ...
            $.ajax({
                url: site_url + 'settings/promotion/load' + methods,
                type: 'post',
                data: { search: search },
