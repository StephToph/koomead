            ...
            <div class="dasboard-wrapper fl-wrap">
                <div class="dasboard-listing-box fl-wrap">
                    <div class="dasboard-opt sl-opt fl-wrap">
                        <a href="javascript:;" class="gradient-bg dashboard-addnew_btn pop show-popup-form" pageTitle="Add Role" pageName="<?php echo site_url('settings/roles/manage'); ?>" pageSize="">Add New <i class="fal fa-plus"></i></a>	
                        <!-- price-opt-->
